...
const Employers = () => {
  ...
  return (
    <main
      id="employers"
      className="bg-gradient-to-b  from-[#E6EEFF] to-[#FFFFFF] lg:h-[160vh] h-[100%] flex 
      flex-col justify-center items-center  "
    >
      <section className="flex flex-col lg:justify-center items-center justify-between py-10">
        <p className="lg:text-2xl text-4xl font-medium mb-2">How it works</p>
        <p className="lg:text-md text-xl">For Employers</p>
      </section>
      <section
        className="grid gap-10 lg:grid-cols-2 lg:h-[130vh] h-[100%] lg:grid-rows-2 lg:gap-10 content-center justify-items-center
       lg:w-[60%] w-[100%] "
      >
        {Steps.map((step, index) => (
          <div
            ...
            className="bg-gradient-to-b  rounded-r-[30px] w-[80%] py-8 px-4 my-3
              relative  from-[#FFFFFF] to-[#E9E9E9] lg:h-[40vh]  lg:w-[80%] lg:py-5 lg:px-4"
          >
            <img
              src={step.image}
      ...
      <div className="bg-[#062182] w-[100%] flex justify-center items-center lg:h-[30vh] my-5 py-3 ">
        <p className="text-white text-center lg:w-[70%]  lg:text-xl text-[13px] font-mono lg:leading-normal  leading-[16px]">
